...
public class OlsVarables
{
    ...
    public static String PasswordInputField="div.col-sm-10 input#PKeyPassword";
    public static String KNDPDropDownList="div.col-sm-10 select#CAsServersSelect.form-control.m-b";
    public static String KNDPDropDownListTestKNDP="select#CAsServersSelect option[data-index-id='30']";
    public static String CheckboxRememberPasswordForSession="label.i-checks span#cbNeedSaveKeyAndPwdLabel";
    public static String ChooseFileFromPc="span.group-span-filestyle.input-group-btn[tabindex='0']";
    public static String EnterButtonAuthPage="button#btnLogon[type='button'].btn.btn-primary";
...
// Client
    ...
    public static String TrinsactionMaoCountOfDocsToBy="div.text-left.input-group input#orderCreateModel_Nomenclatures_0_MaoDocsCount";
    ...
    public static String Step21OccupTypeYO="select#step2Model_OccupType option[value='0'][selected='selected']";
    public static String Step21OccupTypeVidocremleniyPidrozdil="select#step2Model_OccupType option[value='1'][label='Відокремлений підрозділ";
    public static String Step21PhoneNumberInputField="div.input-group.col-xs-12 input#step2Model_Phone";
    public static String Step21EmailMainInputField="div.input-group.col-xs-12 input#step2Model_EMail";
    public static String Step21YoAdressChange="div[style='display: inline-flex'] a.d-f-a-c[data-popover='Змінити']";
    public static String Step21YoAdressSetModalIndexField="div.input-group input#index";
    public static String Step21YoAdressSetModalIndexFieldFindeButton="div.input-group span.input-group-addon[role='button'] i.glyphicon.glyphicon-refresh.text-success-dker";
    public static String Step21YoAdressSetModalSaveButton="div.modal-footer.ng-scope button.btn.btn-primary.ng-scope";
    public static String Step21CopyYoAdressToPostAdressButton="div.col-xs-12.col-sm-8.col-lg-8 div.text-left.p-b-10 a.btn.btn-default.ng-binding[tabindex='0']";
    public static String Step21YoAdressSetModalRegionValue="button.btn.btn-default.form-control.ui-select-match";
    public static String Step21PostAdressChange="div.col-xs-12.col-lg-6.left-column div[data-ng-hide='hideNotRequiredFields()'] a.d-f-a-c";
    public static String TaxSystemDropDownList="select#step2Model_TaxSystem";
    public static String TaxSystemDropDownGetValueWithIndex1="select#step2Model_TaxSystem option[value='1']";

    public static String IPNNumberInputField="input#step2Model_IPN";
    public static String NumberOfPdvPayerInputField="input#step2Model_PDVNumber";
    public static String NumberOfStpPayerInputField="input#step2Model_STPNumber";


    public static String ChiefPosition="input#step2Model_Head_Position";
    public static String ChiefDrfo="input#step2Model_Head_DRFO";
    public static String ChiefPib="input#step2Model_Head_FIO";
    public static String Iban="input#step2Model_Account";
